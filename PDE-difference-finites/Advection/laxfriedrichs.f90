...
!!$ Saving the initial stuff
  ...
  call save1Ddata(Nx,t,x,u_e,'u_e_lf',0)
  call save1Ddata(Nx,t,x,u_n,'u_n_lf',0)
...
!!$ Integration loop
  ...
  do l=1,Nt
     ...
     do i=1,Nx-1
        ...
        u_n(i) = 0.5 * (u_n_p(i+1)+u_n_p(i-1))-(u_n_p(i+1)-u_n_p(i-1))*(dt/(2*dx))
     ...
     call save1Ddata(Nx,t,x,u_e,'u_e_lf',1)
     call save1Ddata(Nx,t,x,u_n,'u_n_lf',1)
