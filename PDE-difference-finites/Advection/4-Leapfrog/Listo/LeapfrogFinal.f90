...
!!$  loop de integración  
  do l=1,Nt
  t = t + dt
  ! dos reciclado de variables

  u_n_p_o=u_n_p  ! valor en un paso de tiempo anterior 'u_n_o' a  'u_n_p_o' (función que itera en un paso de tiempo anterior) 	  
  u_n_p=u_n		 !Asigno el primer valor de u_n a la función u_n_p (condic aión inicial)
...
! do i=1, Nx-1   !Guardo u_n en u_n_p_o  para que ahora u_n en un tiempo anterior cuando entre al loop
 !u_n_p_o(i)=u_n_p(i)  !2do reciclado de variable
 !end do 
